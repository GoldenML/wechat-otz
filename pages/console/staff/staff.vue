<template>
	<view>
		<view style="line-height: 20px; font-size: 14px;">
			全部好友
		</view>
		<uni-list :border="true">
			<uni-list-chat v-for="(item, index) in proxy.$store.state.friendInfos" :key="index" :avatar-circle="true"
				:title="item.nickname" :avatar="item.avatar" showSwitch clickable></uni-list-chat>
